...
describe("Test Handler Seekers/CanGetLoggedInSeeker", () => {
  it("user_can_view_seeker_story_which_will_pass", async () => {
    let result = {};
    try {
      ...
      result = await testStrategy("Seekers/CanGetLoggedInSeeker", {
